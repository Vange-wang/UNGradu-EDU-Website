...
export const GET: RouteHandlers["GET_MESSAGES"] = (...args) =>
  getHandlers().GET_MESSAGES(...args);
export const POST: RouteHandlers["POST_MESSAGES"] = (...args) =>
  getHandlers().POST_MESSAGES(...args);
